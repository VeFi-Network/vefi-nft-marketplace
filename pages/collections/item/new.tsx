  ...
  return (
    <MainContainer>
        ...
        <ParentExploreAndData>
            ...
            <div className="text">
            File type supported: jpg, png, gif, Mp4, SVG, WEBM, <br /> Mp3, WAV, OGG, GLB, GLTF,    <span className="blue"> Max size 40mb</span>  
            </div>
            ...
            <div className="text">
            VefiNft will include a link to this URL on this item’s <br /> detail page so users can click to learn more about it <br /> so you are welcome to link your own web page with <br /> more details.
            </div>
            ...
            >
                {colValue}  
                {
                    colValue=='Select collection' && <Image width="12px" style={{ zIndex: 1 }} height="11px" src="/icons/downIcon.svg" />
                }
                {
                   colDropdown && (
                    <DropdownContainer >
                        <div onClick={()=>setColVal('Collection 1')} className="drop-el">Collection 1</div>
                        <div onClick={()=>setColVal('Collection 2')} className="drop-el">Collection 2</div>
                        <div onClick={()=>setColVal('Collection 3')} className="drop-el">Collection 3</div>
                        <div onClick={()=>setColVal('Collection 4')} className="drop-el">Collection 4</div>
                    </DropdownContainer>
                   )
               }
            </Dropdown>
            ...
            >
                {propertiesValue}  {
                    propertiesValue=='Select properties' && <Image width="12px" style={{ zIndex: 1 }} height="11px" src="/icons/downIcon.svg" />
                }
                
                {
                   propDropdown && (
                    <DropdownContainer >
                        <div onClick={()=>setPropertiesValue('Property 1')} className="drop-el">Property 1</div>
                        <div onClick={()=>setPropertiesValue('Property 2')} className="drop-el">Property 2</div>
                        <div onClick={()=>setPropertiesValue('Property 3')}className="drop-el">Property 3</div>
                        <div onClick={()=>setPropertiesValue('Property 4')} className="drop-el">Property 4</div>
                    </DropdownContainer>
                   )
               }
            </Dropdown>
            ...
            <div className="dropdown-cont">
                ...
                {
                    traitsList && traitsList.map((trait,i)=>(
            ...
            <div className="text">
                Select between Legendary, Rare, Iconic, Super-Rare 
            </div>

            <Dropdown width="130px" top='20px'
                onClick={()=>{
                   setLabelDropdown(!labelDropdown);
                }} 
            >
                {labelValue} {
                    labelValue=='Select label' && <Image width="12px" style={{ zIndex: 1 }} height="11px" src="/icons/downIcon.svg" />
                }
            
                {
                   labelDropdown && (
                    <DropdownContainer width="130px">
                        <div onClick={()=>setLabelValue('Legendary')} className="drop-el">Legendary</div>
                        <div onClick={()=>setLabelValue('Rare')} className="drop-el">Rare</div>
                        <div onClick={()=>setLabelValue('Iconic')} className="drop-el">Iconic</div>
                        <div onClick={()=>setLabelValue('Super-Rare')} className="drop-el">Super-Rare</div>
                    </DropdownContainer>
                   )
               }
            </Dropdown>
