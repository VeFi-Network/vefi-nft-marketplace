      ...
      <FormWrapper>
        ...
        <div className="form__field">
          <div className="title">
            <h3>External link</h3>
            <p>
              VefiNft will include a link to this URL on this item’s detail page so users can click to learn more about
              it so you are welcome to link your own web page with more details.
            </p>
          </div>
          <div className="form__body">
