          ...
          <FormWrapper>
            ...
            <div className="form__field">
              <div className="title">
                ...
                <p>
                  This image will be used to feature your artwork on the home page category pages or other promotional
                  areas in VefiNft. (Optional)
                </p>
              </div>
              <div className="form__body">
            ...
            <div className="form__field">
              <div className="title">
                ...
                <p>
                  ...
                  sale price and paid monthly to a payout adress of your choosen.
                </p>
              </div>
              <div className="form__body">
                <div className="title">
