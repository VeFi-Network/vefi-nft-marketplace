  ...
  return (
        <>
                ...
                <CollectionInfoCont>
                    ...
                    <div className="creator">Created By:  <div className="blue"> Wereywanle</div> <Image src="/icons/verification.svg" alt="" width="20px" height="20px" className="tick" /></div>
                </CollectionInfoCont>
                ...
                <StyledStatsDiv>
                    ...
                    <StatsBox>
                        <div className='big-num'> <Image src="/icons/eth_classic.svg" width="47px" height="47px"/> 2.0</div>
                        <div className="blue-div">Floor Price</div>
                    </StatsBox>

                    <StatsBox>
                        <div className='big-num'><Image src="/icons/eth_classic.svg" width="47px" height="47px"/> 20.5</div>
