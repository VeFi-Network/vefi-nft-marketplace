...
export default function GreyContainer({}: Props) {
  ...
  return (
    <GreyContainerMain>
      ...
      <NFTContainer>
        <Card name="God of War" imageURI="/nft/nft01.png" price="247" owner="ToomuchLag"></Card>
        <Card name="Rolling Ape" imageURI="/nft/nft02.png" price="7" owner="Unknowest"></Card>
        <Card name="Lost in Space" imageURI="/nft/nft03.png" price="2" owner="Wereywanle"></Card>
        <Card name="Rolling Ape" imageURI="/nft/nft02.png" price="7" owner="Unknowest"></Card>
      </NFTContainer>
    </GreyContainerMain>
  );
